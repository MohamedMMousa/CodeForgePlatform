...
namespace CodeForge.Application.Announcements.UpdateAnnouncement
{
    public class UpdateAnnouncementCommandHandler : IRequestHandler<UpdateAnnouncementCommand, AnnouncementDto>
    {
        ...
        public UpdateAnnouncementCommandHandler(ICodeForgeDbContext context, ICurrentUserService currentUserService)
        {
            _context = context;
        ...
        public async Task<AnnouncementDto> Handle(UpdateAnnouncementCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                throw new UnauthorizedAccessException("Only the author or an admin can edit this announcement.");
            }
            ...
            _context.ActivityLogs.Add(ActivityLogFactory.Create(
                currentUserId, "announcement.updated", nameof(Announcement), announcement.Id,
